...
func TestFileStorePut(t *testing.T) {
	const savedFileContent = `{"accessToken":"sometoken","expiredAt":1000000001,"appName":"com_oursky_skygear","authInfoID":"someuserinfoid"}
`
	token := Token{
		AccessToken: "sometoken",
		ExpiredAt:   time.Unix(1, 1).UTC(),
		AppName:     "com_oursky_skygear",
		AuthInfoID:  "someuserinfoid",
	}
...
func TestFileStorePutZeroExpiry(t *testing.T) {
	const savedFileContent = `{"accessToken":"sometoken","expiredAt":0,"appName":"com_oursky_skygear","authInfoID":"someuserinfoid"}
`
	token := Token{
		AccessToken: "sometoken",
		ExpiredAt:   time.Time{},
